...
* Try the previous 2 steps for seveal different random number seeds.
...
* The code running the model is in the function/script `simulate_stochastivirus.R`. Check the help file for both functions to see how to use them.
