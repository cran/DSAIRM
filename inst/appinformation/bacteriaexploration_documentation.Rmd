...
### Task 1: 
* Set initial bacteria to 100 and immune response to 10.
* Set bacteria growth rate to 2 and death rate to 1. The former value does not matter since we'll be exploring the simulation for different values of _g_.
...
* Set maximum simulation time to 300. Run simulation, check to ensure all simulations reach steady state (see output message below plot). Then reduce simulation time to 20 days, note how some simulations did not reach steady state and how that affects results.
