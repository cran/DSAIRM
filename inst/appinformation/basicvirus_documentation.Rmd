...
```{r virusdiagram, fig.cap='',  echo=FALSE, out.width = "70%"}
...
* Assume that infected cells have an average life-span of 1 day, and virus has a life-span of 6 hours (remember that the inverse of the lifespan is the rate of death, and make sure you convert to the right units).
...
_0 = n - d~U~ U - bUV_, _0 = bUV - d~I~_, _0 = pI - d~V~ V - gb UV_. One can solve those equations for each of the compartments to get a mathematical expression of what _U_, _I_ and _V_ are at steady state. If your algebra is not too rusty, try to do this. You should find that _U~s~ = d~I~ d~V~/(b(p - d~I~ g))_ and similar (slightly bigger) equations for _I~s~_ and _V~s~_ (the subscript _s_ denotes that these are the steady-state values of the variables).
